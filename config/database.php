...
if (!defined('DB_HOST')) {
    define('DB_HOST', getenv('DB_HOST') ?: ($_ENV['DB_HOST'] ?? 'mysql-39596ad9-ajith.b.aivencloud.com'));
}
if (!defined('DB_PORT')) {
    define('DB_PORT', (int)(getenv('DB_PORT') ?: ($_ENV['DB_PORT'] ?? 28611)));
}
if (!defined('DB_NAME')) {
    define('DB_NAME', getenv('DB_NAME') ?: ($_ENV['DB_NAME'] ?? 'defaultdb'));
}
if (!defined('DB_USER')) {
    define('DB_USER', getenv('DB_USER') ?: ($_ENV['DB_USER'] ?? 'avnadmin'));
}
if (!defined('DB_PASS')) {
    define('DB_PASS', getenv('DB_PASSWORD') ?: getenv('DB_PASS') ?: ($_ENV['DB_PASSWORD'] ?? ($_ENV['DB_PASS'] ?? 'AVNS_c5evB7knXM5nrNtAhSx')));
}
